...
```{webr-r}
# ============================================================
#        INGRESE SUS DATOS (Solo modifique los números)
# ============================================================

ahorros_actuales_usd       <- 30000    # Total ahorros en USD
salario_mensual_usd        <- 2333     # Ingreso mensual neto en USD
tasa_ahorro_pct            <- 0.50     # % del salario disponible para  vivienda + ahorro
...
n_simulaciones             <- 500     # Cantidad de escenarios (1 - 1000, más da mayor precisión pero tarda más)
