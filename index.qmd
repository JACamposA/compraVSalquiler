...
filters:
  - webr
webr:
  packages: ['MASS', 'ggplot2', 'dplyr', 'tidyr', 'scales', 'Matrix', 'base64enc']
...
img1_b64 <- base64enc::base64encode("/tmp/plot1.png")
img2_b64 <- base64enc::base64encode("/tmp/plot2.png")
img3_b64 <- base64enc::base64encode("/tmp/plot3.png")
...
html_b64 <- base64enc::base64encode(charToRaw(html_content))
...
cat("👉 Haga clic en el enlace de abajo para ver el reporte completo:\n\n")

# Create clickable link using htmltools
htmltools::browsable(htmltools::tags$a(
  href = data_uri,
  target = "_blank",
