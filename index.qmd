...
```{=html}
<style>
/* Ocultar editor de código en bloques de ejecución y gráficos */
#ejecutar-todo .webr-monaco-editor-container,
#ejecutar-todo .monaco-editor,
#ejecutar-todo .webr-code-editor,
#grafico-evolucion .webr-monaco-editor-container,
#grafico-evolucion .monaco-editor,
#grafico-evolucion .webr-code-editor,
#grafico-distribucion .webr-monaco-editor-container,
#grafico-distribucion .monaco-editor,
#grafico-distribucion .webr-code-editor,
#grafico-diferencia .webr-monaco-editor-container,
#grafico-diferencia .monaco-editor,
#grafico-diferencia .webr-code-editor {
...
# Meses de depósito que pide el propietario (típico: 1-3)
...
ggplot(resultados_final, aes(x = patrimonio / 1000, fill = tipo_clean)) +
  ...
  scale_color_manual(values = c("Compra" = "#2E86C1", "Alquiler" = "#E67E22")) +
  labs(
    title = sprintf("Distribución del Patrimonio Final (%d años)", p$plazo_anos),
