...
(function () {
  ...
  // The R console output lands as one big HTML blob (lines joined by <br>)
  // inside #sim-app .qwebr-output-code-area pre. Reclassify each line as a
  ...
  function beautifyOutput() {
    ...
    target.innerHTML = lines.map(function (line) {
      ...
      if (text && /[A-ZÁÉÍÓÚÑ]/.test(text) && text === text.toUpperCase()) {
        return '<div class="rs-heading">' + line + "</div>";
      }
      return '<div class="rs-line">' + line + "</div>";
    }).join("");
  }
