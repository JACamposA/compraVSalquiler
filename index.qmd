...
salario_mensual_inicial_usd <- 1000    # 👈 Su salario mensual en dólares
tasa_ahorro_pct <- 0.50                # 👈 % que puede ahorrar sin contar vivienda (0.50 = 50%)
...
enganche_pct <- 0.20                   # 👈 Pago inicial (0.20 = 20%)
...
deposito_alquiler_meses <- 3           # 👈 Valor de mudanza en meses de alquiler
comision_inmobiliaria_alquiler <- 1    # 👈 Meses de comisión al entrar a un nuevo departamento
...
apreciacion_propiedad_anual_usd <- 0.02  # Apreciación inmuebles (Con inflación del dólar)
