...
ejecutar_y_mostrar <- function(ahorros_actuales_usd, salario_mensual_usd, tasa_ahorro_pct,
 ...
 params <- construir_params(ahorros_actuales_usd, salario_mensual_usd, tasa_ahorro_pct,
  ...
  g1 <- ggplot(patrimonio_por_año, aes(x = año, color = tipo_clean, fill = tipo_clean)) +
    ...
    labs(title = "Evolución del Patrimonio", subtitle = "Línea: mediana | Banda oscura: 50% | Banda clara: 80%",
  ...
  g2 <- ggplot(resultados_final, aes(x = patrimonio / 1000, fill = tipo_clean)) +
    ...
    scale_fill_manual(values = c("Compra" = "#7fc1ec", "Alquiler" = "#6fe0a0")) +
    scale_color_manual(values = c("Compra" = "#7fc1ec", "Alquiler" = "#6fe0a0")) +
    labs(title = sprintf("Distribución del Patrimonio Final (%d años)", plazo_anos), subtitle = "Líneas punteadas = promedio",
