...
<div class="slider-group">
<label>% del salario ahorrado <span class="slider-value" id="val-tasa_ahorro">50%</span></label>
<input type="range" id="sl-tasa_ahorro" min="0" max="100" step="1" value="50">
<span class="hint">Disponible para vivienda + ahorro</span>
</div>
...
<div class="slider-group">
<label>Enganche <span class="slider-value" id="val-enganche">20%</span></label>
<input type="range" id="sl-enganche" min="0" max="80" step="1" value="20">
<span class="hint">% de entrada al credito UVA</span>
</div>
...
<div class="slider-group">
<label>Deposito (meses) <span class="slider-value" id="val-deposito">3</span></label>
<input type="range" id="sl-deposito" min="0" max="6" step="1" value="3">
<span class="hint">Meses de garantia/mudanza</span>
</div>
...
<span class="hint">Retorno esperado anual (ej. S&P 500)</span>
</div>

<div class="slider-group">
<label>Cantidad de simulaciones <span class="slider-value" id="val-nsim">500</span></label>
<input type="range" id="sl-nsim" min="50" max="1000" step="50" value="500">
<span class="hint">Mas escenarios = mayor precision, mas tiempo</span>
</div>
